      ...
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-4xl font-black tracking-tight italic">
            Editar <span className="text-[#d4ff3f]">Orçamento</span>
          </h1>
          <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">Atualização completa de fases e serviços (TCPO)</p>
        </div>
      </div>

...
export async function GET() {
  try {
    ...
    const fetchEvents = async (token: string) => {
      ...
      const res = await fetch(`https://www.googleapis.com/calendar/v3/calendars/primary/events?timeMin=${timeMin}&maxResults=250&singleEvents=true&orderBy=startTime`, {
        headers: {
